...
ALTER TABLE "section_e" ADD FOREIGN KEY ("id") REFERENCES "base_maintenance" ("id");

ALTER TABLE "navic_performance_details" ADD FOREIGN KEY ("section_e_id") REFERENCES "section_e" ("id");
